...
# create testimages
filepath_fixed_image=('/Users/peterbehringer/MyTesting/SimpleITK_Tests/fixed_image.nrrd')
filepath_moving_image=('/Users/peterbehringer/MyTesting/SimpleITK_Tests/moving_image.nrrd')
filepath_fixed_image_mask=('/Users/peterbehringer/MyTesting/SimpleITK_Tests/fixed_image_mask.nrrd')
filepath_moving_image_mask=('/Users/peterbehringer/MyTesting/SimpleITK_Tests/moving_image_mask.nrrd')

filepath_registered_output_volume=('/Users/peterbehringer/MyTesting/SimpleITK_Tests/registered_output_volume.nrrd')
filepath_euler_trans=('/Users/peterbehringer/MyTesting/SimpleITK_Tests/euler_trans.h5')
...
writer.SetFileName(filepath_fixed_image)
...
# write moving_image
writer=sitk.ImageFileWriter()
writer.SetFileName(filepath_moving_image)
...
# write image
writer=sitk.ImageFileWriter()
writer.SetFileName(filepath_moving_image_mask)
writer.Execute(moving_image_mask)
...
# write image
writer=sitk.ImageFileWriter()
writer.SetFileName(filepath_fixed_image_mask)
writer.Execute(fixed_image_mask)

# _____________________________________________________________________________________________________________________ #


# show in Slicer
slicer.util.loadVolume(filepath_moving_image)
slicer.util.loadVolume(filepath_fixed_image)
slicer.util.loadLabelVolume(filepath_fixed_image_mask)
slicer.util.loadLabelVolume(filepath_moving_image_mask)
...
output_volume_after_init = resampler.Execute(moving_image)

simg2 = sitk.Cast(sitk.RescaleIntensity(output_volume_after_init), sitk.sitkUInt8)

sitk.WriteImage(simg2,filepath_registered_output_volume)